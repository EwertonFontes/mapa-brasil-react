...
const MapaBR = ({estadoClicado}) => {
  return (
    <div className='mapa-br'>
    <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="100%" height="460px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" >
      <g>
        <a className="estado" name="Tocantins" code="17" onClick={() => estadoClicado("Tocantins (TO)")}>
        ...
        <a className="estado" name="Bahia" code="29" onClick={() => estadoClicado("Bahia (BA)")}>
        ...
        <a  className="estado" name="Sergipe" code="28" onClick={() => estadoClicado("Sergipe (SE)")}>
        ...
        <a  className="estado" name="Pernambuco" code="26" onClick={() => estadoClicado("Pernambuco (PE)")}>
        ...
        <a  className="estado" name="Alagoas" code="27" onClick={() => estadoClicado("Alagoas (AL)")}>
        ...
        <a class="estado" name="Rio Grande do Norte" code="24" onClick={() => estadoClicado("Rio Grande do Norte (RN)")}>
        ...
        <a  className="estado" name="Ceará" code="23" onClick={() => estadoClicado("Ceará (CE)")}>
        ...
        <a className="estado" name="Piauí" code="22" onClick={() => estadoClicado("Piauí (PI)")}>
        ...
        <a className="estado" name="Maranhão" code="21" onClick={() => estadoClicado("Maranhão (MA)")}>
        ...
        <a className="estado" name="Amapá" code="16" onClick={() => estadoClicado("Amapá (AP)")}>
        ...
        <a className="estado" name="Pará" code="15" onClick={() => estadoClicado("Pará (PA)")}>
        ...
        <a className="estado" name="Roraima" code="14" onClick={() => estadoClicado("Roraima (RR)")}>
        ...
        <a className="estado" name="Amazonas" code="13" onClick={() => estadoClicado("Amazonas (AM)")}>
        ...
        <a className="estado" name="Acre" code="12" onClick={() => estadoClicado("Acre (AC)")}>
        ...
        <a className="estado" name="Rondônia" code="11" onClick={() => estadoClicado("Rondônia (RO)")}>
        ...
        <a className="estado" name="Mato Grosso" code="51" onClick={() => estadoClicado("Mato Grosso (MT)")}>
        ...
        <a className="estado" name="Mato Grosso do Sul" code="50" onClick={() => estadoClicado("Mato Grosso do Sul (MS)")}>
        ...
        <a className="estado" name="Goiás" code="52" onClick={() => estadoClicado("Goiás (GO)")}>
        ...
        <a className="estado" name="Paraná" code="41" onClick={() => estadoClicado("Paraná (PR)")}>
        ...
        <a className="estado" name="Santa Catarina" code="42" onClick={() => estadoClicado("Santa Catarina (SC)")}>
        ...
        <a className="estado" name="Rio Grande do Sul" code="43" onClick={() => estadoClicado("Rio Grande do Sul (RS)")}>
        ...
        <a className="estado" name="São Paulo" code="35" onClick={() => estadoClicado("São Paulo (SP)")}>
        ...
        <a className="estado" name="Minas Gerais" code="31" onClick={() => estadoClicado("Minas Gerais (MG)")}>
        ...
        <a className="estado" name="Rio de Janeiro" code="33" onClick={() => estadoClicado("Rio de Janeiro (RJ)")}>
        ...
        <a className="estado" name="Espírito Santo" code="32" onClick={() => estadoClicado("Espírito Santo (ES)")}>
        ...
        <a  className="estado" name="Distrito Federal" code="53" onClick={() => estadoClicado("Distrito Federal (DF)")}>
        ...
        <a className="estado" name="Paraíba" code="25" onClick={() => estadoClicado("Paraíba (PB)")}>
